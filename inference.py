...
class Args:
    def __init__(self, driven_audio='./examples/driven_audio/bus_chinese.wav', 
                 ...
                 pose_style=0, batch_size=2, expression_scale=1.0, 
                 input_yaw=None, input_pitch=None, input_roll=None, 
                 enhancer=None, background_enhancer=None, 
                 cpu=False, face3dvis=False, still=False, 
                 preprocess='crop', net_recon='resnet50', init_path=None, 
                 use_last_fc=False, bfm_folder='./checkpoints/BFM_Fitting/', 
                 bfm_model='BFM_model_front.mat', focal=1015.0, center=112.0, 
                 camera_d=10.0, z_near=5.0, z_far=15.0):
...
if __name__ == '__main__':
    args = Args(source_image='new_image_path.png', cpu=True)
